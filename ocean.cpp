...
double Ocean::_kappa_h_double() {
    double kh = 1 - pow(this->_M_h_double(), 2);
    return kh;
}
...
double Ocean::_kappa_v_double() {
    double kv = 1 - pow(this->_M_v_double(), 2);
    return kv;
}
...
double Ocean::_kappa_double() {
    return this->_kappa_v_double() * pow(cos(alpha * PI/180), 2) + this->_kappa_h_double() * pow(sin(alpha * PI/180), 2);
}
